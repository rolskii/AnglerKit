...
export default function MeasureBar({ distanceLabel, pointCount, onUndo, onClear, onSave }) {
  return (
    <div className="absolute top-[88px] left-1/2 -translate-x-1/2 z-[500] flex items-center gap-3 px-4 py-2 rounded-full bg-primary text-primary-foreground text-sm font-medium shadow-lg">
