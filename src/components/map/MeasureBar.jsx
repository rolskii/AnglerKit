...
export default function MeasureBar({ totalKm, pointCount, onUndo, onClear }) {
  return (
    <div className="absolute top-[88px] left-1/2 -translate-x-1/2 z-[500] flex items-center gap-3 px-4 py-2 rounded-full bg-blue-500 text-white text-sm font-medium shadow-lg">
      ...
      <button onClick={onUndo} className="ml-1 p-1 rounded-full hover:bg-white/20 transition-colors">
