        ...
        <div className="px-4 pb-4 space-y-3">
          ...
          <div className="bg-primary/10 rounded-xl p-4 space-y-3">
            ...
            <div className="grid grid-cols-4 gap-1">
              <div className="bg-secondary p-1.5 rounded-lg flex flex-col items-center gap-0.5 min-w-0 overflow-hidden">
                <WeatherGlyph code={51} className="w-6 h-7 shrink-0" />
                <p className="text-[10px] font-semibold leading-tight whitespace-nowrap">{midHumidity != null ? midHumidity + '%' : '—'}</p>
              ...
              <div className="bg-secondary p-1.5 rounded-lg flex flex-col items-center gap-0.5 min-w-0 overflow-hidden">
                ...
                <p className="text-[10px] font-semibold leading-tight whitespace-nowrap">{midPressure != null ? (midPressure / 10).toFixed(1) + 'kPa' : '—'}</p>
