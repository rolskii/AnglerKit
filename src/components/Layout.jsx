      ...
      <aside className="hidden md:flex fixed inset-y-0 left-0 w-64 flex-col border-r border-border bg-sidebar p-4">
        <div className="flex items-center gap-2 px-2 py-3 mb-4">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary text-primary-foreground">
            <img src="https://media.base44.com/images/public/6a3f2458eb55a5d860886e35/d4a98df2c_fly.png" alt="Fly Fish" className="w-7 h-7 object-contain [mix-blend-mode:multiply]" />
          </div>
          <div>
      ...
      <header className="md:hidden sticky top-0 z-30 flex items-center justify-between border-b border-border bg-sidebar px-4 py-3">
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary text-primary-foreground">
            <img src="https://media.base44.com/images/public/6a3f2458eb55a5d860886e35/d4a98df2c_fly.png" alt="Fly Fish" className="w-6 h-6 object-contain [mix-blend-mode:multiply]" />
          </div>
