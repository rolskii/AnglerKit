...
import { Download, Upload, Loader2, FileJson, CheckCircle2, AlertCircle, RotateCcw, HardDrive } from "lucide-react";
...
export default function ImportExportSection() {
  ...
  const handleBackup = async () => {
    ...
    try {
      ...
      const payload = { app: "HeronWise", version: 2, exported_at: new Date().toISOString(), data };
        downloadFile(`heronwise-backup-${date}.json`, JSON.stringify(payload, null, 2), "application/json");
