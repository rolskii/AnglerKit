          ...
          <CardContent className="p-4">
            <div className="space-y-3">
              ...
              <div className="flex gap-2">
                <div className="flex-1 min-w-0 bg-secondary p-2.5 rounded-lg flex flex-col items-center gap-1">
                  <WeatherGlyph code={51} className="w-8 h-9 shrink-0" />
                ...
                <div className="flex-1 min-w-0 bg-secondary p-2.5 rounded-lg flex flex-col items-center gap-1">
                  <WeatherGlyph code={45} className="w-8 h-9 shrink-0" />
                ...
                <div className="flex-1 min-w-0 bg-secondary p-2.5 rounded-lg flex flex-col items-center gap-1">
                  <WeatherGlyph code={63} className="w-8 h-9 shrink-0" />
                  <p className="text-[11px] font-semibold leading-tight">
                ...
                <div className="flex-1 min-w-0 bg-secondary p-2.5 rounded-lg flex flex-col items-center gap-1">
                  <WeatherGlyph code={3} className="w-8 h-9 shrink-0" />
