  ...
  return (
    <div className="space-y-8 max-w-3xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="font-heading text-2xl font-bold">About Fly Fish</h1>
      ...
      <div className="prose prose-sm max-w-none text-foreground/90 space-y-4">
        <p>
          Fly Fish is your ultimate fly fishing gear manager — built to help you organize
        ...
        <p>
          ...
          Whether you're chasing trout on a quiet stream or swinging for steelhead, Fly Fish
