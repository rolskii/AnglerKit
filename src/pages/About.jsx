  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      <div className="prose prose-sm max-w-none text-foreground/90 space-y-4">
        ...
        <p>From gear tracking into an indispensable fishing toolbox - pairing detailed equipment management with real-time conditions intelligence, maps complete i so you always know what's in your kit and what the water and sky are doing before you head out.
