  ...
  return (
    <div className="space-y-8 max-w-3xl">
      ...
      <div className="prose prose-sm max-w-none text-foreground/90 space-y-4">
        ...
        <p>The HeronWise App has grown from a simple gear tracker into an indispensable tackle box — pairing detailed equipment management with real-time conditions intelligence, and maps complete with saved location pins and route recording. You'll always know what's in your arsenal and what the water and sky are doing before you head out.
