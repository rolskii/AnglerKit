                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div className="bg-secondary rounded-xl flex items-center gap-2 p-2.5">
                      ...
                      <div className="min-w-0">
                        ...
                        <span className="text-[10px] text-muted-foreground/70 leading-tight mt-0.5">{data.current?.datetimeLocal ? new Date(data.current.datetimeLocal).toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit' }) : '—'}</span>
                      </div>
                    </div>
                    <div className="bg-secondary rounded-xl flex items-center gap-2 p-2.5">
