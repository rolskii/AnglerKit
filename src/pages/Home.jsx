  ...
  return (
    <div className="space-y-6 md:space-y-8">
      <div className="space-y-2 px-1">
        ...
        <p className="text-sm md:text-[17px] text-muted-foreground">Organize your entire fishing arsenal—track gear, predict the best fishing times with moon phases, check the weather and log every catch in one place.</p>
      </div>
