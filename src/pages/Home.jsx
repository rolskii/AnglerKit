  ...
  return (
    ...
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="space-y-2 px-1">
        <p className="text-sm font-medium text-muted-foreground">Built for Dedicated Anglers</p>
        ...
        <div className="px-4 py-3 rounded-2xl bg-card shadow-sm space-y-3">
          <div className="flex items-center justify-between gap-2">
            <div className="flex flex-col gap-1">
              <p className={`text-sm font-bold ${moonPhase.fishingRating >= 5 ? "animate-neon-flash" : "text-foreground"}`}>Today's Fishing Conditions</p>
