            ...
            <tbody>
              {filtered.map((line) => (
                <tr
                  ...
                  className={`border-t border-border cursor-pointer hover:bg-accent/50 transition-colors ${line.reel && line.reel.toLowerCase() !== "spooled" && !line.spooled ? "bg-primary/5" : ""}`}
                >
