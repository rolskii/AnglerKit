    ...
    <div className="min-h-screen bg-background px-4 pb-20 pt-0">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Check lunar phases and solunar feeding times.</p>
          ...
          <div className="mt-6 grid grid-cols-2 gap-2 max-w-md mx-auto items-start">
            ...
            <div className="box-border min-w-0">
              ...
              <input
                ...
                className="w-full h-9 px-3 py-1 text-sm border border-border rounded-lg bg-card text-foreground text-left box-border appearance-none"
              />
            </div>
          </div>
        </div>
